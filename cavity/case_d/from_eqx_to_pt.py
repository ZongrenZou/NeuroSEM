...
LOAD_UV_MODEL_NAME = "./checkpoints/RBC_uvp_1e4.eqx"
LOAD_THETA_MODEL_NAME = "./checkpoints/RBC_theta_1e4.eqx"
SAVE_UV_MODEL_NAME = "./checkpoints/traced_rbc_model_1e6.pt"
...
class NeuralNetwork(nn.Module):
    ...
    def __init__(self, units=50):
        ...
        self.linear5 = nn.Linear(units, 3)
...
model_uv = NeuralNetwork(units=units)
