...
if __name__ == "__main__": 
    ...
    N_EPOCHS = int(10000)
    batch_size = 50000
    SAVE_MODEL_NAME = "./checkpoints/PINN0.eqx"
    ...
    @eqx.filter_jit
    def train_step_opt(network, params_state, xyt_d, uv_d):
        l, grad = eqx.filter_value_and_grad(models.loss_fn_1)(
            network, DATA_WEIGHT, PDE_WEIGHT, xyt_d, uv_d, Re,
        )
    ...
    for epoch in range(N_EPOCHS):
        ...
        for i in range(N_data // batch_size + 1):
            ...
            pinn, opt_state, loss = train_step_opt(
                pinn, opt_state, xyt_d_batch, uv_d_batch,
            )
